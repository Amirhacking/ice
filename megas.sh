...
function beyondteam() {
	echo -e "\e[0m"
	green "                         اینم ادیت کردن دیوثا خخخ                                "
	green "                        Source Private                                     "
	white "                          Channel : @source_hut                               "
	red   "                        Developer Source : @S_A_F_T                                   "
	echo -e "\e[0m"
}
...
if [ ! -f ./data/tg/tgcli ]; then
   ...
   ./data/tg/tgcli -s ./data/bot.lua -l 1 -E $@
