--Begin msg_checks.lua By @source_hut
...
if not redis:get('autodeltime') then
  ...
  tdcli.sendMessage(msg.to.id, "", 0, "_برای خرید ربات به گروه پشتیبانی زیر مراجعه کنید_ :\nhttps://t.me/joinchat/AAAAAEMtHkP9bLsZ1q5iMA", 0, "md")
...
local english_caption = msg.media.caption:match("[qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM]") 
...
kick_user(user, chat)
				...
				local badword_msg = msg.text:match("کص")or msg.text:match("کون")or msg.text:match("ممه")or msg.text:match("کیری")or msg.text:match("حرومی")or msg.text:match("ننه") or msg.text:match("کصده")or msg.text:match("کث")or msg.text:match("کسکش")or msg.text:match("کصکش")or msg.text:match("لاشی")or msg.text:match("ناموس")or msg.text:match("جنده")or msg.text:match("یتیم")or msg.text:match("خارکسده")or msg.text:match("مادرجنده")or msg.text:match("حرومزاده")or msg.text:match("خواهرجنده")or msg.text:match("خواهرتو")or msg.text:match("مادرتو")or msg.text:match("کونی")or msg.text:match("اوبی")or msg.text:match("لاشی")or msg.text:match("kir")or msg.text:match("kos")or msg.text:match("lashi")
if badword_msg
and lock_badword == "yes" then
 if is_channel then
 del_msg(chat, tonumber(msg.id))
  elseif is_chat then
kick_user(user, chat)
