do
-- #Begin plugins.lua by @source_hut
...
local function list_all_plugins(only_enabled, msg)
  ...
  text = '<code>'..text..'</code>\n\n'..nsum..' <b>📂پلاگین نصب شده است</b>\n\n'..nact..' <i>✔️پلاگین فعال است</i>\n\n'..nsum-nact..' <i>❌پلاگین غیرفعال است</i>'..tmp
...
local function list_plugins(only_enabled, msg)
  ...
  text = "\n_🔃تمامی پلاگین های ربات بارگذاری شدند_\n\n"..nact.." *✔️پلاگین فعال است*\n"..nsum.." *📂پلاگین نصب شده است*\n"..msg_caption
