-- source_hut
tdcli = dofile('./data/tg/tdcli.lua')
serpent = (loadfile "./data/libs/serpent.lua")()
feedparser = (loadfile "./data/libs/feedparser.lua")()
require('./data/utils')
require('./data/libs/lua-redis')
URL = require "socket.url"
http = require "socket.http"
https = require "ssl.https"
ltn12 = require "ltn12"
json = (loadfile "./data/libs/JSON.lua")()
mimetype = (loadfile "./data/libs/mimetype.lua")()
redis = (loadfile "./data/libs/redis.lua")()
JSON = (loadfile "./data/libs/dkjson.lua")()
local lgi = require ('lgi')
local notify = lgi.require('Notify')
notify.init ("Telegram updates")
chats = {}
plugins = {}
helper_username = 'HELPERICEROBOT'  -- Input Helper Username Here Without @
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {111334847,429592338,342293523, sudo_id},
    admins = {},
    disabled_channels = {},
